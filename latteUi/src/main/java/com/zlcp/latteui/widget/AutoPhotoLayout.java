package com.zlcp.latteui.widget;
...
//                final AppCompatImageView deleteImageView = (AppCompatImageView) v;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int sizeWidth = View.MeasureSpec.getSize(widthMeasureSpec);
        final int modeWidth = View.MeasureSpec.getMode(widthMeasureSpec);  //specMode包含UNSPECIFIED,EXACTLY,AT_MOST,表示测量模式
